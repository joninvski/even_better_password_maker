 ...
 * 
 * This object stores a plain array of chars allowing the data to be erased back
 * to 0 at any given time.
 * 
...
public class SecureCharArray {
	...
	/**
	 * Erases the data in this array by writing a pattern over every element of
	 * the array.
	 * 
	 ...
	 * 
	 * @param index
	 *            The index to obtain the character at.
